                    ...
                    <form method="POST" action="{{ route('materials.store') }}">
                        ...
                        <div class="flex mt-4 space-x-4">
                            ...
                            <div class="w-1/2">
                                ...
                                <x-text-input id="unit" class="block mt-1 w-full" type="text" name="unit" :value="old('unit')" required placeholder="e.g., ream, box, piece" />
                            ...
                            <div class="w-1/2">
                                ...
                                <x-text-input id="quantity" class="block mt-1 w-full" type="number" name="quantity" :value="old('quantity', 0)" required step="0.01" min="0" />
                        ...
                        <div class="flex mt-4 space-x-4">
                            ...
                            <div class="w-1/2">
                                ...
                                <x-text-input id="reorder_level" class="block mt-1 w-full" type="number" name="reorder_level" :value="old('reorder_level', 10)" required min="0" />
                            ...
                            <div class="w-1/2">
                                ...
                                <x-text-input id="unit_price" class="block mt-1 w-full" type="number" name="unit_price" :value="old('unit_price', 0)" required step="0.01" min="0" />
